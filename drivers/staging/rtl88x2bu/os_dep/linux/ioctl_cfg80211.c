...
NDIS_802_11_NETWORK_INFRASTRUCTURE nl80211_iftype_to_rtw_network_type(enum nl80211_iftype type)
{
	...
	#if defined(CONFIG_P2P) && ((KERNEL_NEW) || defined(COMPAT_KERNEL_RELEASE))
...
#if defined(CONFIG_GTK_OL) && (KERNEL_NEW)
				     ...
				     struct vif_params *params)
{
	...
	case NL80211_IFTYPE_P2P_GO:
		...
		break;
#endif /* defined(CONFIG_P2P) && ((KERNEL_NEW) || defined(COMPAT_KERNEL_RELEASE)) */
...
void rtw_cfg80211_indicate_sta_assoc(_adapter *padapter, u8 *pmgmt_frame, uint frame_len)
{
	...
	#if   (KERNEL_NEW) && !defined(CONFIG_CFG80211_FORCE_COMPATIBLE_2_6_37_UNDER)
...
#if CONFIG_RTW_MACADDR_ACL && (KERNEL_NEW)
...
#endif /* CONFIG_RTW_MACADDR_ACL && (KERNEL_NEW) */
...
#if defined(CONFIG_TDLS) && (KERNEL_NEW)
...
#if defined(CONFIG_RTW_MESH) && (KERNEL_NEW)
...
#if defined(CONFIG_80211AC_VHT) && (KERNEL_NEW)
...
#endif /* defined(CONFIG_80211AC_VHT) && (KERNEL_NEW) */
...
#if (KERNEL_NEW) && defined(RTW_SINGLE_WIPHY) && (CONFIG_IFACE_NUMBER >= 2)
...
#if defined(CONFIG_RTW_HOSTAPD_ACS) && (KERNEL_NEW)
...
#endif /* defined(CONFIG_RTW_HOSTAPD_ACS) && (KERNEL_NEW) */
...
#if defined(RTW_VENDOR_EXT_SUPPORT)
